...
export const featuresData = [
  ...
  {
    icon: <PieChart className="h-8 w-8 text-cyan-600" />,
...
export const testimonialsData = [
  {
    ...
    quote:"Budget-ing lets me have account and with that it even suggests me to spend wisely"  },
  {
    name: "Michael Chen",
    role: "Freelancer",
  ...
  },
  {
    ...
    quote:
      "I recommend Budget-ing to all my clients. The multi-currency support and detailed analytics make it perfect for international investors.",
  },
];